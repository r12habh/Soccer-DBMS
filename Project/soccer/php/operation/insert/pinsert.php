...
$iteam = $_POST["team"];
	 ...
	 $sql_p="Insert into football_league.player(playerid, fname, lname, position, weight, height, nationality, kitinteger, teamname) values(\"$iplayerid\",\"$ifname\", \"$ilname\", \"$ipostion\", \"$iweight\", \"$iheight\", \"$inationality\", \"$ikitinteger\", \"$iteam\")";
